...
class Migration(migrations.Migration):
    ...
    replaces = [('web', '0001_initial'), ('web', '0002_auto_20190325_2127'), ('web', '0003_notifs'), ('web', '0004_auto_20190423_2012'), ('web', '0005_schedule'), ('web', '0006_auto_20190428_0818'), ('web', '0007_auto_20190428_0859'), ('web', '0008_auto_20190428_0901'), ('web', '0009_auto_20190428_0907')]
    ...
    operations = [
        migrations.CreateModel(
            name='Jids',
            fields=[
                ('jid', models.CharField(db_index=True, max_length=255, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('accepted', 'accepted'), ('rejected', 'rejected'), ('denied', 'denied'), ('unaccepted', 'unaccepted')], max_length=64)),
            ],
            options={
                'db_table': 'salt_keys',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.Minions')),
            ],
            options={
