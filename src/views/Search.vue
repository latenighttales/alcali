          ...
          <v-card>
            ...
            >
              <template v-slot:item.jid="{ item }">
                <v-btn text small class="text-none" :class="item.jid.includes(query) ? 'red': ''"
                       :to="'/jobs/'+item.jid+'/'+item.id">{{ item.jid }}
                </v-btn>
              </template>
              <template v-slot:item.fun="{ item }">
                <span :class="item.fun.includes(query) ? 'red': ''">{{item.fun}}</span>
              </template>
          ...
          <v-card>
            ...
            >
              <template v-slot:item.minion_id="{ item }">
                <v-btn text small class="text-none" :class="item.minion_id.includes(query) ? 'red': ''"
                       :to="'/minions/'+item.minion_id">{{ item.minion_id }}
                </v-btn>
              </template>
