...
def __virtual__():
    if not HAS_MYSQL:
        return False, 'Could not import alcali returner; ' \
...
def _get_options(ret=None):
    ...
    _options = salt.returners.get_returner_options('mysql',
                                                   ret,
                                                   attrs,
                                                   __salt__=__salt__,
                                                   __opts__=__opts__,
...
def returner(ret):
    ...
    try:
        ...
        log.critical(exc)
        log.critical('Could not store return with Alcali returner. MySQL server unavailable.')
...
def event_return(events):
    ...
    '''
    keys_status = {'minions_rejected': 'rejected',
